...
<div class="d-flex">
    <nav class="sidebar bg-dark">
        <ul class="list-unstyled">
            <li><a href="../admin/user-list.jsp"><i class="fa fa-book fa-fw"></i> Books</a></li>
            <li><a href="../admin/approved"><i class="fa fa-book fa-fw"></i> Approved</a></li>
            <li><a href="../admin/users"><i class="fa fa-book fa-fw"></i> Users</a></li>

        </ul>
        <hr class="my-4">
        <ul class="list-unstyled">
            <li><a href="#"><i class="fa fa-book fa-fw"></i> About</a></li>
